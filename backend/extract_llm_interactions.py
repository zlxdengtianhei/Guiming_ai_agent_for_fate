...
if __name__ == '__main__':
    log_file = '/Users/lexuanzhang/code/tarot_agent/backend/test_reading_log_20251106_230806.json'
    interactions, full_data = extract_llm_interactions(log_file)
    print_interactions(interactions)
    
    # 保存到文件
    output_file = '/Users/lexuanzhang/code/tarot_agent/backend/llm_interactions_extracted.json'
