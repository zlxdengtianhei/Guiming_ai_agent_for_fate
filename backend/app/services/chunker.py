...
Implements word-based chunking with overlap for optimal retrieval.
"""
...
class TextChunker:
    ...
    def chunk_text(self, text: str, source: str, base_chunk_id: str, metadata: Dict[str, Any] = None) -> List[Dict[str, Any]]:
        """
        ...
        Returns:
            List of chunk dictionaries with chunk_id, source, text, and metadata
        """
    ...
    def chunk_documents(self, documents: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        Args:
            documents: List of documents with 'text', 'source', 'chunk_id', and optional 'metadata' keys
        ...
        for doc in documents:
            ...
            chunks = self.chunk_text(text, source, base_chunk_id, metadata)
