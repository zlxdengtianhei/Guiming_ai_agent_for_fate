...
if __name__ == "__main__":
    ...
    default_prompt = (
        ...
        "CRITICAL SIZE REQUIREMENT: The two figures (the female Tarot reader and the ancient Chinese sage) must be relatively small. Their maximum height should NOT exceed half of the vertical edge height (1/2 of the vertical dimension). They should be positioned in a way that they take up at most 1/2 of the vertical edge height, leaving the other half or more of the vertical space for other elements, symbols, patterns, or background. Make the figures smaller and more compact to ensure they do not dominate the composition vertically. "
        "TEXT REQUIREMENT: At the very center of the composition, display the Chinese characters '归命' (guī mìng) prominently. The text should be clearly visible and positioned at the exact center of the image, both horizontally and vertically. The characters should be styled to match the mystical and abstract aesthetic of the illustration, using colors that complement the overall palette (deep blue, gold, or yellow)."
    )
